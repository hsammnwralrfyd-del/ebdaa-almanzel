...
export function getServiceHeroPath(service: ServiceDefinition): string {
  if (service.hasHeaderImage) {
    return `${import.meta.env.BASE_URL}${service.folder}/header.webp`;
  }
  return `${import.meta.env.BASE_URL}${service.folder}/1.webp`;
}
...
export const servicesList: ServiceDefinition[] = [
  {
    ...
    galleryImageCount: 4,
    cardImage: `${import.meta.env.BASE_URL}structural-canopies/1.webp`,
    icon: Grid,
  ...
  },
  {
    ...
    hasHeaderImage: false,
    galleryImageCount: 4,
    cardImage: `${import.meta.env.BASE_URL}laser-cut-canopies/1.webp`,
    icon: Zap,
    features: defaultFeatures,
    benefits: [
      "تصاميم حديثة ودقيقة",
  ...
  },
  {
    ...
    hasHeaderImage: false,
    galleryImageCount: 4,
    cardImage: `${import.meta.env.BASE_URL}arch-canopies/1.webp`,
    icon: Layout,
    features: defaultFeatures,
    benefits: [
      "تصاميم أنيقة",
  ...
  },
  {
    ...
    hasHeaderImage: false,
    galleryImageCount: 4,
    cardImage: `${import.meta.env.BASE_URL}garage-canopies/1.webp`,
    icon: Warehouse,
    features: defaultFeatures,
    benefits: [
  ...
  },
  {
    ...
    hasHeaderImage: false,
    galleryImageCount: 4,
    cardImage: `${import.meta.env.BASE_URL}warehouses/1.webp`,
    icon: Warehouse,
    features: defaultFeatures,
    benefits: [
      "عزل حراري ممتاز",
  ...
  },
  {
    ...
    hasHeaderImage: false,
    galleryImageCount: 4,
    cardImage: `${import.meta.env.BASE_URL}fencing/1.webp`,
    icon: Fence,
    features: defaultFeatures,
    benefits: [
      "خصوصية كاملة",
  ...
  },
  {
    ...
    hasHeaderImage: false,
    galleryImageCount: 4,
    cardImage: `${import.meta.env.BASE_URL}roof-insulation/1.webp`,
    icon: Droplets,
    features: defaultFeatures,
    benefits: [
  ...
  },
  {
    ...
    hasHeaderImage: false,
    galleryImageCount: 4,
    cardImage: `${import.meta.env.BASE_URL}water-thermal-insulation/1.webp`,
    icon: Shield,
    features: defaultFeatures,
    benefits: [
      "أفضل المواصفات",
  ...
  },
  {
    ...
    hasHeaderImage: false,
    galleryImageCount: 4,
    cardImage: `${import.meta.env.BASE_URL}cladding-canopies/1.webp`,
    icon: Layers,
    features: defaultFeatures,
    benefits: [
      "تصاميم عصرية",
  ...
  },
  {
    ...
    hasHeaderImage: false,
    galleryImageCount: 4,
    cardImage: `${import.meta.env.BASE_URL}landscaping/1.webp`,
    icon: TreePine,
    features: defaultFeatures,
    benefits: [
      "تصاميم متنوعة",
