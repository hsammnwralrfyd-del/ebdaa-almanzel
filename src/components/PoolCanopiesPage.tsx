...
const PoolCanopiesPage = () => {
  useSEO({
    title: "مظلات مسابح بمكة المكرمة  | تغطية مسابح بمكة المكرمة  | ربوع البلاد",
    description:
      "مؤسسة ربوع البلاد تقدم خدمات تصميم وتركيب مظلات وتغطية مسابح بمكة المكرمة ، بتصاميم عملية وأنيقة وحلول مناسبة للمنازل والفلل والاستراحات والمنشآت.",
    keywords:
      "مظلات مسابح بمكة المكرمة , تغطية مسابح بمكة المكرمة , مظلات مسابح, تغطية المسابح, تركيب مظلات مسابح بمكة المكرمة , مظلات للفلل بمكة المكرمة , مظلات استراحات بمكة المكرمة ",
    ...
    >
      ...
      <section className="relative overflow-hidden bg-black">
        <div className="relative h-[65vh] min-h-[480px] max-h-[760px]">
          <img
            src={images[0]}
            alt="مظلات مسابح بمكة المكرمة  - ربوع البلاد"
          ...
          <div className="relative z-10 flex h-full items-center justify-center px-4 text-center">
            <div className="max-w-4xl text-white">
              ...
              <h1 className="mb-6 text-4xl font-extrabold leading-tight sm:text-5xl md:text-6xl">
                مظلات وتغطية مسابح بمكة المكرمة 
              </h1>
          ...
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
            {images.map((image, index) => (
              ...
              >
                <img
                  src={image}
                  alt={`مظلات مسابح بمكة المكرمة  - صورة ${index + 1}`}
                  loading="lazy"
      ...
      <section className="px-4 py-16 sm:py-20">
        <div className="mx-auto max-w-6xl">
          <div className="mb-10 text-center">
            <h2 className="text-3xl font-extrabold text-[#d1a347] sm:text-4xl">
              خدمات تغطية المسابح بمكة المكرمة 
            </h2>
          </div>
      ...
      <section className="bg-[#111] px-4 py-16 text-white sm:py-20">
        <div className="mx-auto max-w-5xl text-center">
          ...
          <h2 className="mb-6 text-3xl font-extrabold sm:text-4xl">
            مظلات مسابح بمكة المكرمة 
          </h2>

          <p className="text-lg leading-9 text-white/80">
            نخدم العملاء في مدينة مكة المكرمة  ونوفر حلول مظلات وتغطية المسابح
