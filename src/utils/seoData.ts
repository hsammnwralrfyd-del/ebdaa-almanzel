export const seoData = {
  home: {
    title: "مقاولات عامة ومظلات وسواتر وهناجر وعزل وتنسيق حدائق | المنطقة الشرقية",
    description: "مؤسسة إبداع المنزل للمقاولات العامة متخصصة في المظلات والسواتر والهناجر والمستودعات والعزل المائي والحراري وتنسيق الحدائق في الدمام والخبر والمنطقة الشرقية.",
    keywords: "مقاولات عامة المنطقة الشرقية, مظلات الدمام, مظلات الخبر, سواتر الدمام, سواتر الخبر, هناجر الدمام, عزل الأسطح, عزل مائي وحراري, تنسيق حدائق",
    url: "https://hsammnwralrfyd-del.github.io/ebdaa-almanzel/",
  },

  projects: {
    title: "مشاريع مؤسسة إبداع المنزل للمقاولات العامة | المنطقة الشرقية",
    description: "استعرض أعمال ومشاريع مؤسسة إبداع المنزل في المظلات والسواتر والهناجر والعزل وتنسيق الحدائق بالمنطقة الشرقية.",
    keywords: "مشاريع مقاولات المنطقة الشرقية, مشاريع مظلات, مشاريع سواتر, مشاريع هناجر, مشاريع عزل, مشاريع تنسيق حدائق",
    url: "https://hsammnwralrfyd-del.github.io/ebdaa-almanzel/",
  },
