...
const SchoolCanopiesPage = () => {
  const title = "مظلات مدارس بمكة المكرمة  | ربوع البلاد";

  const description =
    "مظلات مدارس بمكة المكرمة  من مؤسسة ربوع البلاد. تصميم وتنفيذ وتركيب مظلات المدارس والساحات والممرات ومواقف السيارات والمنشآت التعليمية في مكة المكرمة .";

  useSEO({
    title,
    description,
    keywords:
      "مظلات مدارس بمكة المكرمة , مظلات مدارس, مظلات ساحات المدارس بمكة المكرمة , مظلات ممرات المدارس, مظلات مواقف مدارس, تركيب مظلات مدارس بمكة المكرمة ",
    url: "https://rubou-albilad.com/school-canopies",
    image: "https://rubou-albilad.com/school-canopies/header.webp",
    structuredData: {
      "@context": "https://schema.org",
      "@type": "Service",
      name: "مظلات مدارس بمكة المكرمة ",
      description,
      url: "https://rubou-albilad.com/school-canopies",
      areaServed: {
        "@type": "City",
        ...
        <div className="container relative z-10 mx-auto px-4 text-white">
          <div className="max-w-3xl">
            ...
            <p className="mb-8 text-lg leading-9 text-white/90 sm:text-xl md:text-2xl">
              ...
              السيارات في مكة المكرمة ، بحلول عملية تناسب المنشآت التعليمية
              والمساحات الخارجية.
            </p>
        ...
        <div className="container mx-auto max-w-5xl px-4">
          ...
          <div className="mb-12 text-center">
            ...
            <h2 className="mb-5 text-3xl font-extrabold text-[#b88a2d] sm:text-4xl">
              مظلات مدارس في مكة المكرمة 
            </h2>

            <p className="text-lg leading-9 text-gray-700">
              تقدم ربوع البلاد خدمات تصميم وتنفيذ وتركيب مظلات المدارس
              بمكة المكرمة ، مع حلول مناسبة للساحات والممرات ومداخل المباني
          ...
          <div className="grid grid-cols-1 gap-5 sm:grid-cols-2">
            ...
            {images.map((image, index) => (
              ...
              >
                <img
                  src={image}
                  alt={`مظلات مدارس بمكة المكرمة  - صورة ${index + 1}`}
      ...
      <section className="bg-[#171717] py-16 text-center text-white">
        ...
        <div className="container mx-auto px-4">
          ...
          <h2 className="mb-5 text-3xl font-extrabold sm:text-4xl">
            هل تبحث عن مظلات مدارس بمكة المكرمة ؟
          </h2>
