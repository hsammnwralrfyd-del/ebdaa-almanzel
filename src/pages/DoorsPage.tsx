  ...
  const detailedServices = [
    {
      ...
      alt: "تركيب قرميد خرساني فاخر في مكة المكرمة ",
    },
    {
      title: "سقف قرميدي للفيلات",
      image: "/roof-tiles/2.webp",
      alt: "سقف قرميدي للفيلات في مكة المكرمة ",
    },
    {
      title: "قرميد للمنازل",
      image: "/roof-tiles/3.webp",
      alt: "قرميد للمنازل في مكة المكرمة ",
    },
    {
      title: "قرميد مودرن",
      image: "/roof-tiles/4.webp",
      alt: "قرميد مودرن في مكة المكرمة ",
    },
  ];
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl animate-fade-in-up">
            ...
            <h1 className="text-4xl md:text-6xl lg:text-7xl font-black mb-6 leading-tight text-white drop-shadow-lg">
              ...
              <span className="block mt-2" style={{ color: '#d1a347' }}>في مكة المكرمة </span>
            </h1>
